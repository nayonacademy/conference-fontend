...
class ConferenceClaim extends React.Component{
    render(){
        return(
                ...
                <div className="w-col w-col-6">
                  <div className="card claim">
                    ...
                    <div className="w-form">
                      <form id="email-form"><label>Full name</label>
                      <input type="text" className="claim-form w-input" max={256} name="name" data-name="Name" placeholder="Full name" id="name" />
                          <label>Email address</label>
                          <input type="email" className="claim-form w-input" max="256" name="Email-address" data-name="Email address" placeholder="Email address" id="Email-address" />
                              <label>Website</label><input type="text" className="claim-form w-input" max="256" name="Website" data-name="Website" placeholder="Website" id="Website" />
                                  ...
                                  <input type="text" className="claim-form w-input" max={256} name="Conference-or-Business-Name" data-name="Conference or Business Name" placeholder="Conference or Business Name" id="Conference-or-Business-Name" />
                                      <label >Street Address</label>
                                  <input type="text" className="claim-form w-input" max={256} name="Mailing-Address" data-name="Mailing Address" placeholder="Street Address" id="Mailing-Address" />
                        ...
                        </div><input type="submit" value="Start!" data-wait="Please wait..." className="submit-button-2 w-button"/></form>
